...
<head>
    ...
    <title>Contact Us-ANITS BloodBank & Donor Management System</title>
...
<body>
    ...
    <div class="container">
		...
		<h1 class="mt-4 mb-3" style="color:#B32320; font-family:'abril fatface';"><b>Contact Us</b></h1>
        ...
        <div class="row">
            <!-- Map Column -->
			  ...
			  <h3>Our Address:</h3>
			  <h5 style="color:#B32320;">Near Three Temples  Sanghivalasa, Bheemunipatnam, Visakhapatnam, Andhra Pradesh 531162</h5>
                <h3>General Enquiries:</h3>
				<h5 style="color:#B32320;">ANITSbloodbank@gmail.com</h5>
				<h3>Call Us:</h3>
				<h5 style="color:#B32320;">9876543210</h5>
                ...
                <form name="sentMessage"  method="post">
                    ...
                    <button type="submit" style="background-color:#B32320;" name="send"  class="btn btn-primary">Send Message</button>
                </form>
            </div>
