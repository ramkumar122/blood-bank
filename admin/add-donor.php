...
<head>
	...
	<title>Admin Add Donor-ANITS BloodBank & Donor Management System</title>
...
<textarea class="form-control" name="message" required> </textarea>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<button class="btn btn-default" style="background-color:#B32320;" type="reset">Cancel</button>
													<button class="btn btn-primary" style="background-color:#B32320;" name="submit" type="submit">Save changes</button>
												</div>
											</div>
