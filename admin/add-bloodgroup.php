...
<head>
	...
	<title>Admin Add-Bloodgroup-ANITS BloodBank & Donor Management System</title>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" style="background-color:#B32320;" name="submit" type="submit">Submit</button>
												</div>
											</div>
