...
<head>
    ...
    <title>Search For Blood-ANITS BloodBank & Donor Management System</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <br><ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" >Search For Blood</li>
        </ol>
		<h1 class="mt-4 mb-3" style="color:#B32320; font-family:'abril fatface';"><b>Search For Blood</b></h1>
...
<div class="col-lg-4 mb-4">
<div class="font-cabin">Location </div>
...
echo htmlentities("No Record Found");
  ...
  <br><br><br><br><br><br><br><br><br><br><br><br><br><?php include('includes/footer.php');?>
